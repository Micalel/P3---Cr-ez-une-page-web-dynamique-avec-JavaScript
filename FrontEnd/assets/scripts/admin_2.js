     ...
     */
        ...
        async function displayFormInModal() {
            ...
            <button type="submit" class="form-btn--validate" disabled> Valider </button>`;
            ...
            const submitButton = formContainer.querySelector('.form-btn--validate') 
            let canvas;

            // Gestion de l'activation du bouton de validation
            const validateForm = () => {
                ...
                submitButton.disabled = !(title && category && file)
            }
